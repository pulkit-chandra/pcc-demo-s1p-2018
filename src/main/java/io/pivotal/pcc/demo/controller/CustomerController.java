package io.pivotal.pcc.demo.controller;
...
public class CustomerController {
	...
	@Autowired
	io.pivotal.pcc.demo.repo.jpa.CustomerRepository pccCustomerRepository;
	
	@Autowired
	io.pivotal.pcc.demo.repo.jpa.CustomerRepository jpaCustomerRepository;
